...
Before acting, load this skill's unconditional opening reads in one message — four `run_shell_command` calls, with the project root as the working directory, sent together.
