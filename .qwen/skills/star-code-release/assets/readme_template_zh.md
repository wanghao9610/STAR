<!-- Compiled by /star-code-release on <YYYY-MM-DD> · model_id: <模型 id，照抄运行时本会话为你声明的那串——Qwen Code 在会话开始注入；仅当本会话未声明任何模型才写 "unrecorded"> · sources: <产物>@<日期>, … · report: wkdrs/release/RELEASE_<date>.md · Regenerate with /star-code-release readme; hand edits to a section are detected and kept. -->
