...
### Step 1: Scan
Load everything in one message — two `run_shell_command` calls, both with the project root as the working directory. First call, the conventions excerpts:
