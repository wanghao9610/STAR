...
|---|---|---|---|---|---|---|
| `<prefix>_<slug>` | `<prefix>_<slug>_plan.md` | in_progress | 3/5 | <value> — provisional (unverified) | `<path:line>` | `/skill:star-expt-analyst <run dir>` |
...
- <signal> — `<prefix>_<slug>`, <where it is recorded> → `/skill:star-plan-reviser <slug>`
