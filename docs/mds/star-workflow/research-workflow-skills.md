...
| Full filename | `01_mvp-3way-verify_plan.md` | The most explicit form; recommended when roots or names overlap |
...
$star-expt-analyst wkdrs/01_mvp-3way-verify/      # a run directory
...
If the report recommends `00_baseline-method-impl`, run:
...
1. Run the command recorded in `wkdrs/00_baseline-method-impl/EXEC_LOG.md`;
