...
description: >-
  ...
  a decomposition axis (phase / component / evidence), confirms the unit list, expands the next
  runnable unit into a full sub-plan — later units stay outline lines in the parent, expanded as
  execution reaches them. A sub-plan can be decomposed again. Use when the user runs
  star-plan-decomposer, or wants a plan split into sub-plans or the next outlined unit expanded.
  Bilingual (en/zh).
---
