...
Before drafting, read `docs/mds/star-workflow/human-writing-guide.md`. Apply it to README prose while preserving measured numbers, run names, commands, paths, provenance, technical distinctions, negative results, uncertainty, and `TODO` markers; do not turn missing evidence into sales copy or unsupported superlatives.
