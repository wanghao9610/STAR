...
Before acting, load it in one message — three Shell calls with the project root as the working directory, plus a `Read` of the question bank Stages 1, 2 and 4 draw on (`<this skill's directory>/references/question_bank.md`), all sent together.
