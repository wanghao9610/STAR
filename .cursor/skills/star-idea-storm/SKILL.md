...
- Always ask only one question at a time; the two gates — the keep-set (Stage 2) and the decision (Stage 4) — always wait for an explicit answer.
