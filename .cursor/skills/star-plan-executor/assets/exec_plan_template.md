...
created: <YYYY-MM-DD>
approved: <YYYY-MM-DD>               # date the user approved this (after plan-mode gate)
...
<!-- Material deltas between this EXEC_PLAN and the sub-plan's §2–§5 (references/plan_sync_rules.md):
     ...
     Extra concreteness is NOT a divergence. Approving this plan approves syncing these rows back
     into the sub-plan; mark `synced` once written back. Write "None" if faithful. -->
