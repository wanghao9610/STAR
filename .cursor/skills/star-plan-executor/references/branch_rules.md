...
6. Choosing the branch chooses per-step commits with it: a branch with nothing committed has nothing to merge, so a commit-less branch run does not exist.
