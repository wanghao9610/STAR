...
const AgentScopeSchema = StringEnum(["user", "project", "both"] as const, {
	description: 'Which agent directories to use. Default: "project". Use "both" to add the user-level agents.',
	default: "project",
});
...
export default function (pi: ExtensionAPI) {
	pi.registerTool({
		...
		description: [
			...
			`Agent scope defaults to "project" — STAR's roster in ${CONFIG_DIR_NAME}/agents.`,
