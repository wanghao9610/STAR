...
3. **The user owns every change.** Findings become numbered revision candidates. Each is adopted / adjusted / skipped in a question of its own, one candidate per message, with your recommendation marked — never bundle-approve, never edit unasked.
