...
A programme of ≤ ~6 reports is usually simplest to read in the main agent. Above that, partition the **report paths** across read-only collection passes, run one at a time, each given its exact list and this return contract:
