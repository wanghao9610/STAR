...
- A dropped plan's files move aside, names unchanged, to `metds/plans/dropped/`, `wkdrs/dropped/<run>/`, `tasks/dropped/<plan-name>/`, and `execs/scpts/dropped/` — `star-plan-reviser`'s drop does the move, a revival reverses it.
