...
- The two git-ignored subdirectories split what stays on this machine by scope: a fact true everywhere goes to `.star/memory/global/`, a `machine:`, `plan:` or `code:` scoped one to `.star/memory/local/`.
