...
The last covered date is the newest digest's `covers.through` — read from frontmatter, never inferred. It makes `/skill:star-expt-digest` with no argument mean "since last time".
