...
The three README rules nothing else checks: families 3 and 4 already re-check every printed command, image, relative link and anchor, but nothing checks where a number came from.
