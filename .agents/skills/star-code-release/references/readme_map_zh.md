...
|---|---|---|---|---|---|
| 1 | 头部——标题、标语、徽章、teaser | M | `metds/overview.md` §问题 + §核心想法 | 仓库目录名、`.env` 的 `CODE_NAME`、`metds/refs/reference.bib` 自条目 | 标题取仓库名/`CODE_NAME`；标语写 `TODO` → `$star-metd-summarize overview` |
