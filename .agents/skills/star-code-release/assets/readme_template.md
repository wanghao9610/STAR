<!-- Compiled by star-code-release on <YYYY-MM-DD> · model_id: <model id, self-reported at write time; "unrecorded" if the runtime states none — docs/mds/star-workflow/research-workflow-conventions.md §8> · sources: <artifact>@<date>, … · report: wkdrs/release/RELEASE_<date>.md · Regenerate with star-code-release readme; hand edits to a section are detected and kept. -->
