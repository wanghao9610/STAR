...
<!-- What problem, what idea, what it achieved — just enough for a reader to decide whether
     to open the paper. -->
...
<!-- A short description: what the figure shows and how to read it — the parts and how they connect, the
