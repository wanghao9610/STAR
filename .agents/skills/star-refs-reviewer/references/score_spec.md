...
4. A brief digest: entries refreshed vs kept, the moves — any paper whose score crossed a whole point — and the failures, each keeping its old value and date, never a guess.
