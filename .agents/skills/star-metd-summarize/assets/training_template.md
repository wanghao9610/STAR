...
<!-- Per stage: the entry point, the config, and the launch command through the project's .env
     interpreter (via execs/run.sh where the plans use one), plus where outputs are written under wkdrs/. Commands
