...
Before acting, load it in one message — three shell calls with the project root as the working directory, plus a file read of the question bank Stages 1, 2 and 4 draw on (`<this skill's directory>/references/question_bank.md`), all sent together.
