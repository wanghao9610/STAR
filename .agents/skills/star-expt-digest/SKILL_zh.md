...
起草前读 `docs/mds/star-workflow/human-writing-guide.zh-CN.md`（英文：`docs/mds/star-workflow/human-writing-guide.md`）。覆盖区间、来源层级、数字、裁决、临时标签、命令、负面结果和计划发现都是受保护内容；行文调整可以理清关系，但不得自行推断因果，也不得淡化不利结果。
