...
<!-- Written by star-plan-reviser (model_id: <model id, self-reported at write time; "unrecorded" if the runtime states none — docs/mds/star-workflow/research-workflow-conventions.md §8>). Target: metds/plans/<file>; node type: leaf | internal | root;
