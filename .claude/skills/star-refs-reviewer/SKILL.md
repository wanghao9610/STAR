...
- The core-set confirmation is the only mandatory question — one AskUserQuestion, multiSelect, recommendations marked. If AskUserQuestion is unavailable (headless / scripted), fall back to plain text and require an explicit answer before reading.
