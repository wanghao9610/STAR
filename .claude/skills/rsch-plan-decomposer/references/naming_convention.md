...
- **Depth = prefix length.** A root plan (from `rsch-plan-coach`) has a 1-digit prefix (`0_`). Its children have 2-digit prefixes, grandchildren 3-digit, and so on.
