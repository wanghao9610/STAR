...
### Step 1: Scan
Load everything in one message — two Bash calls, both with the project root as the working directory, plus a read of the spec issued alongside them. First call, the conventions excerpts:
