...
2. If no argument was given or the match is ambiguous, list candidates (prefix + slug + one-line state) and ask via AskUserQuestion — prefer nodes with execution evidence (`exec_run` set) or known drift.
