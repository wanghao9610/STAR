...
description: >-
  ...
  /skill:star-plan-executor, when a run names it as the next action, or wants to execute / implement /
  carry out / run a sub-plan, turn an execution plan into code and results, or start the work a plan
  describes. Bilingual (en/zh).
---
