...
- Never move, rename, or delete files or directories — structural change belongs to `/skill:star-code-architect`. Residual-list names are flagged, never renamed.
