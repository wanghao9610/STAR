...
Invocation: `/skill:star-plan-reviser PLAN_NAME`, where `PLAN_NAME` is a slug (`open-vocab-det-seg`), a numeric prefix (`01`), or a filename (`01_mvp-3way-verify_plan.md`). With no argument, list candidates and ask — prefer nodes with execution evidence or flagged drift.
