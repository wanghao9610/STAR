...
Four lines a unit, and each stays one line: this is the sketch Step 4 expands into the six sections, not a draft of them. Then confirm via AskUserQuestion (*looks good* / *edit the list* / *change granularity*, with your recommendation marked).
