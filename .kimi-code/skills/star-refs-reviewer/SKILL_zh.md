...
8. **摘要。** ≤400 字：来源与画像、计数账、写了哪些支、自查结果，以及转交——补读清单逐篇 `/skill:star-refs-reviewer <arxiv-id>`、或整单一次 `/skill:star-refs-reviewer add …`；定位交 `/skill:star-plan-coach` §2（相关工作与定位）；项目需要笔记和核验 bib 时走完整流程。
