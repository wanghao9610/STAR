...
description: >-
  ...
  star-metd-summarize [OPT] — overview, dataset, framework, training, evaluation; no argument
  ...
  star-metd-summarize, when a run names it as the next action or wants the plans consolidated into
