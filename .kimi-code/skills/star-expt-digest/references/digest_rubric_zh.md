...
4. 进入 `wkdrs/results/results.md` 或任何按范围的 `wkdrs/results/results_<slug>.md`——digest 不写台账，而台账自身的信任模型要从源头重新核实，临时数字按定义就没过这一关；
...
- 用一个从句点明还有什么没测。本周期若只给五条 claim 中的两条产出了数字，就该说清还有哪三条悬着。
