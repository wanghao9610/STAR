...
<!-- 接下来要做的一两件事，各附确切命令。只路由，不动手：未分析的 run 交 /skill:star-expt-analyst，过期台账
     交 /skill:star-expt-analyst aggregate，未执行或待用户的叶子交 /skill:star-plan-executor，被证伪的 claim 交
