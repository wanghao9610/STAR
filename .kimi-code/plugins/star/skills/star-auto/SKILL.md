...
For an unmarked skill, start it with the Skill tool and follow the Kimi-owned copy from the current project's available skills. For a skill marked † in the roster, dispatch a subagent that reads that Kimi-owned skill's `SKILL.md` in full and follows it, as the shared file says.
